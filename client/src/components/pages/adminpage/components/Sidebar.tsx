...
function SidebarContent({ activePage, setActivePage, setSidebarOpen, menuItems, isMobile }: any) {
    return (
        <div className="flex flex-col h-full text-slate-600">
            <div className="p-6 flex items-center gap-3 text-slate-800">
                ...
                <div>
                    <h1 className="font-bold text-lg leading-tight tracking-tight">ClinicHub</h1>
                    <p className="text-xs text-slate-500 font-medium tracking-wide uppercase">Admin Portal</p>
                </div>
            </div>
